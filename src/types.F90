...
module types
   ...
   type :: swarm
      ...
      real           :: mswarm   ! total mass of the group (mswarm = npar*mass)
      ...
      real           :: fw ! water contant, mw/mass
      real           :: w ! water contant, mw/ms
      real           :: rhoi ! internal density
#endif
   end type swarm

   type :: list_of_swarms
      type(swarm), dimension(:), allocatable :: p
      integer :: first_idx ! index of the first particle in swrm

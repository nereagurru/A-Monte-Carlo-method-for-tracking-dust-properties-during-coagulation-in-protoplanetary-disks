...
SRC_DIR = src
ifneq (,$(filter mcdust,$(MAKECMDGOALS)))
    SRC_DIR = src_mcdust
endif
...
$(EXECUTABLE): $(OBJ_DIR)/main.o $(OBJ_DIR)/timestep.o $(OBJ_DIR)/hdf5output.o $(OBJ_DIR)/collisions.o $(OBJ_DIR)/advection.o $(OBJ_DIR)/grid.o $(OBJ_DIR)/parallel_sort.o $(OBJ_DIR)/mrgrnk.o $(OBJ_DIR)/phase_change.o $(OBJ_DIR)/initproblem.o $(OBJ_DIR)/discstruct.o $(OBJ_DIR)/parameters.o $(OBJ_DIR)/types.o $(OBJ_DIR)/constants.o 
...
$(OBJ_DIR)/phase_change.o: $(SRC_DIR)/phase_change.F90 $(OBJ_DIR)/discstruct.o $(OBJ_DIR)/constants.o $(OBJ_DIR)/parameters.o $(OBJ_DIR)/types.o $(OBJ_DIR)/initproblem.o
...
$(OBJ_DIR)/collisions.o: $(SRC_DIR)/collisions.F90 $(OBJ_DIR)/initproblem.o $(OBJ_DIR)/hdf5output.o $(OBJ_DIR)/grid.o $(OBJ_DIR)/types.o $(OBJ_DIR)/discstruct.o $(OBJ_DIR)/parameters.o $(OBJ_DIR)/constants.o
...
$(OBJ_DIR)/main.o: $(SRC_DIR)/main.F90 $(OBJ_DIR)/timestep.o $(OBJ_DIR)/hdf5output.o $(OBJ_DIR)/collisions.o $(OBJ_DIR)/advection.o $(OBJ_DIR)/grid.o $(OBJ_DIR)/initproblem.o $(OBJ_DIR)/phase_change.o $(OBJ_DIR)/discstruct.o $(OBJ_DIR)/parameters.o $(OBJ_DIR)/types.o $(OBJ_DIR)/constants.o
